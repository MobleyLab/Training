...
### Use of AI
At this career stage, you are still a trainee, thus you need to remember we're trying to develop you as a scientist, not generate the largest amount of output in the least amount of time. As discussed in the article ["The machines are fine, I'm worried about us"](https://ergosphere.blog/posts/the-machines-are-fine/), leaning too much on AI too early can put you in a position where you appear very productive but your skill set isn't developing, or even worse, you're generating results that appear correct but which are wrong. Remember that regardless of what tools you use, you always own their output, and you must be in a position to verify the output's correctness. Take time to develop your own expertise; use AI to accelerate the tedious things you already understand well, not to replace taking the time to improve your skill set.  
